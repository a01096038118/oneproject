...
def adminSignUp_form():
    ...
    return render_template('adminSignUp_form.html')
...
def adminSignUp_confirm():
    ...
    if not re.match(id_pattern, mId):
        return render_template('adminSignUp_result.html',
...
def admin_gateway():
    ...
    return render_template('admin_gateway.html')
